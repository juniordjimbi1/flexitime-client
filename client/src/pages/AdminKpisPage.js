...
export default function AdminKpisPage() {
  ...
  return (
    <div className="container py-4">
      <h2 className="fw-bold mb-3">KPIs — Administration</h2>
        ...
        <div className="row g-3 mb-4">
          <div className="col-md-3">
            <div className="p-3 border rounded bg-light h-100">
              ...
              <div className="fw-bold fs-5">{overview.users.total}</div>
              <div className="text-muted small">Emp: {overview.users.employees} · Mgr: {overview.users.managers} · Adm: {overview.users.admins}</div>
            </div>
          </div>
          <div className="col-md-3">
            <div className="p-3 border rounded bg-light h-100">
              <div className="text-muted small">Structure</div>
              <div className="fw-bold fs-5">{overview.structure.departments} Dép. / {overview.structure.teams} Équipes</div>
              <div className="text-muted small">Période {overview.range.from} → {overview.range.to}</div>
            </div>
          </div>
          <div className="col-md-3">
            <div className="p-3 border rounded bg-light h-100">
              <div className="text-muted small">Sessions</div>
              <div className="fw-bold fs-5">{fmtMins(overview.sessions.total_minutes)}</div>
              <div className="text-muted small">{overview.sessions.open_now} en cours</div>
            </div>
          </div>
          <div className="col-md-3">
            <div className="p-3 border rounded bg-light h-100">
              <div className="text-muted small">Tâches</div>
              <div className="fw-bold fs-5">DONE: {overview.tasks.done}</div>
              <div className="text-muted small">TODO: {overview.tasks.todo} · IN PROGRESS: {overview.tasks.in_progress}</div>
            </div>
          </div>
        </div>
      )}
      ...
      <div className="row g-3">
        <div className="col-lg-6">
          <div className="card shadow-sm h-100">
            <div className="card-body">
              <h5 className="card-title">Temps passé par équipe</h5>
              <div className="table-responsive">
                <table className="table table-sm align-middle">
                  <thead><tr><th>Équipe</th><th>Manager</th><th>Temps</th></tr></thead>
                  <tbody>
                    {timeTeams.map(r=>(
                      <tr key={r.team_id}>
                    ...
                    {!timeTeams.length && <tr><td colSpan="3" className="text-muted">Aucune donnée</td></tr>}
                  </tbody>
                </table>
              </div>
            </div>
        ...
        <div className="col-lg-6">
          <div className="card shadow-sm h-100">
            <div className="card-body">
              <h5 className="card-title">Tâches par statut (par équipe)</h5>
              <div className="table-responsive">
                <table className="table table-sm align-middle">
        ...
        <div className="col-12">
          <div className="card shadow-sm">
            <div className="card-body">
              <h5 className="card-title">Clôtures par employé</h5>
              <div className="table-responsive">
                <table className="table table-sm align-middle">
